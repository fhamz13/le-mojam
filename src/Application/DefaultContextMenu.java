...
public class DefaultContextMenu extends JPopupMenu
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7956100919656973175L;
    ...
    private void addPopupMenuItems()
    {
        ...
        selectAll = new JMenuItem("Tout sélectionner");
    ...
    private void processClick(MouseEvent event)
    {
        ...
        if (clipboard.isDataFlavorAvailable(DataFlavor.stringFlavor) && textComponent.isEnabled() && textComponent.isEditable())
        {
            enablePaste = true;
        }
        if (enableUndo == true){
        	if (textComponent.isEditable() == false)
        		enableUndo = false;
        }
